...
import { addNote, removeNote, updateNote } from "./Crud/CrudAction";
...
const handleUpdate = (e) => {
  e.preventDefault();
  dispatch(updateNote(currentId, currentTitle, currentDescription));
  setCurrentId(null);
                ...
                notes.map((u) => (
                  <tr className="table-rw" key={u}>
                    ...
                    <td>
                      <Button
                        className="btn3"
                        onClick={() => dispatch(removeNote(u.id))}>
                        Delete 
                      </Button>
                    </td>
                    <td>
